...
public class ComptabiliteManagerImpl extends AbstractBusinessManager implements ComptabiliteManager {
    ...
    @Override
    public BigDecimal getSoldeComptable(int pCompteComptable) {

    	 List<LigneEcritureComptable>liste;
    	 BigDecimal solde = BigDecimal.ZERO;
         liste=getDaoProxy().getComptabiliteDao().getListLigneEcritureComptableByCompte(pCompteComptable);

         
         if(liste!=null) {
         for (Iterator<LigneEcritureComptable> iterator = liste.iterator(); iterator.hasNext();) {
			LigneEcritureComptable ligne = (LigneEcritureComptable) iterator.next();
